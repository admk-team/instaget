          ...
          <div class="page-header-breadcrumb">
            <ul class="breadcrumb-title">
              <li class="breadcrumb-item">
                <a class="btn-shadow btn btn-primary text-white" href="{{ route('admin.blog.create') }}">
                  Add Blog
                </a>
              </li>
            </ul>
                        ...
                        <div class="dropdown d-inline-block show">
                          ...
                          <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu"
                            ...
                            <ul class="nav flex-column">
                              <li class="nav-item">
                                <a href="{{ route('admin.blog.status',['id'=>$list->id,'status'=>1]) }}"
                                  class="nav-link">Active
                                </a>
                              </li>
                              <li class="nav-item">
                                <a href="{{ route('admin.blog.status',['id'=>$list->id,'status'=>0]) }}"
                      ...
                      <td>
                        <div class="dropdown d-inline-block">
                          ...
                          <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu"
                            ...
                            <ul class="nav flex-column">
                              <li class="nav-item">
                                <a href="{{ route('admin.blog.edit',$list->id) }}" class="nav-link">
                              ...
                              <li class="nav-item">
                                <a href="javascript:void(0);" class="nav-link" type="button"
                                  ...
                                  data-id="{{ route('admin.blog.destroy',$list->id) }}">
