...
<div class="main-body">
    ...
    <div class="page-title-actions">
        <div class="d-inline-block dropdown d-flex justify-content-end mt-2">
          <a class="btn-shadow btn btn-info" href="{{ route('admin.subcategory.create') }}">
            Add Sub Category
          </a>
        </div>
      </div>
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <h4 class="sub-title">Add Categpry</h4>
                                    ...
                                    <div class="dropdown d-inline-block show">
                                      ...
                                      <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu"
                                        ...
                                        <ul class="nav flex-column">
                                          <li class="nav-item">
                                            <a href="{{ route('admin.subcategory.status',['id'=>$list->id,'status'=>1]) }}"
                                              class="nav-link">Active
                                            </a>
                                          </li>
                                          <li class="nav-item">
                                            <a href="{{ route('admin.subcategory.status',['id'=>$list->id,'status'=>0]) }}"
                                  ...
                                  <td>
                                    <div class="dropdown d-inline-block">
                                      ...
                                      <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl dropdown-menu" style="min-width: 9rem;">
                                        <ul class="nav flex-column">
                                          <li class="nav-item">
                                            <a href="{{ route('admin.subcategory.edit',$list->id) }}" class="nav-link">
                                          ...
                                          <li class="nav-item">
                                            <a href="javascript:void(0);" class="nav-link" type="button" onclick="delete_service(this);"
                                              data-id="{{ route('admin.subcategory.destroy',$list->id) }}">
