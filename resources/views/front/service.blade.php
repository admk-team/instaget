    ...
    <div class="container-fluid pt-4 service-feedback">
      <div class="container">
        ...
        <div class="row pt-4">
          ...
          <div class="col-md-6 services-feedback-list">
            <ul class="list-group border-0">
              <li class="list-group-item">
                <div>
                  ...
                  <p>How did you make verified users with hundreds of thousands of followers to like my picture for such a cheap price? You should increase the prices on premium likes, seriously. I would be willing to pay way more for this service and keep the cheapskates out.”</p>
                </div>
              </li>
              <li class="list-group-item">
                <div>
              ...
              <li class="list-group-item">
                <div>
                  ...
                  <p>Awesome app and highly recommend””</p>
                </div>
              </li>
              <li class="list-group-item">
                <div>
