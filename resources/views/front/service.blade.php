...
<head>
  ...
  border: 1px solid rgba(0,0,0,.5); */
    ...
    .insta-danger:not(.collapsed){
      background-color: #d04545;
      color: white;
    }
    .insta-success:not(.collapsed){
      color: white;
    }
  ...
  .talk-accordion{
    ...
    border: 0;
    background-color: #F3F0FF;
    border-left: 3px solid rgb(245, 211, 0);
  }
  button,a,span,p,h1,h2,h3,h4,h5,h6,li{
    font-family: 'Roboto';
  }
  .accordion-item{
    border: 0;
