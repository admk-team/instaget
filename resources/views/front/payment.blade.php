                ...
                <div class="card-body">
                    ...
                    <div class=" pointcontainer">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="100포" aria-label="Recipient's username" aria-describedby="basic-addon2">
                    ...
                    <div class="method">
                        ...
                        <div class="row">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="input-group mb-3 accountdetail">
                                        <select class="form-select" id="">
                                            <option selected>계정27191011722007번호</option>
                                            <option value="1">One</option>
                                            <option value="2">Two</option>
                                            <option value="3">Three</option>
                                        </select>
                                    </div>
                                    <input type="text" class="form-control " placeholder="사용자 이름" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                </div>
                            </div>
